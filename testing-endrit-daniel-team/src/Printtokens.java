...
public class Printtokens{
	...
	{ 
	  //int i=0,j; //These variables add no use to the method
	  int id=0;
	  int res = 0;
	  char ch = '\0';
	...
	{ 
	 if ((str.equals("and") || str.equals("or") || str.equals("if") ||
			 str.equals("xor")||str.equals("lambda")||str.equals("=>")) && (str != null))
	      return true;
	  else 
	      return false;
	}
	...
	{
	  if ((str != null) && (str.length() == 2)  && (str.charAt(0)=='#') && (Character.isLetter(str.charAt(1)))) //Made an edit for the if statement to fix fault
	     return true;
	  else 
	     return false;
	}
	...
	static boolean is_num_constant(String str)
	{
	  ...
	  if ( Character.isDigit(str.charAt(0))) 
		...
		while ( i < str.length() && str.charAt(i) != '\0' )  
	      {
		   if(Character.isDigit(str.charAt(i))) //Removed the +1 to fix the fault in the method
	         i++;
	       else
	         return false;
	      }                         /* end WHILE */
	...
	static boolean is_spec_symbol(char c)
	{
		...
		if (c == '\'')
		{
			return true; //Added this new statement to account for the quote
		}
